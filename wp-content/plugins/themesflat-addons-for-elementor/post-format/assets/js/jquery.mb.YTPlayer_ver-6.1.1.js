    ...
    buildPlayer: function (options) {
      ...
      if (!ytp.YTAPIReady && typeof window.YT === 'undefined') {
        ...
        var tag = jQuery("<script></script>").attr({
          "src": jQuery.mbYTPlayer.locationProtocol + "https://www.youtube.com/iframe_api?v=" + jQuery.mbYTPlayer.version,
          "id" : "YTAPI"
        });
    ...
    getDataFromAPI: function (YTPlayer) {
      ...
      */
      ...
      if (YTPlayer.videoData) {
         ...
         */
        jQuery.getJSON(jQuery.mbYTPlayer.locationProtocol + "https://www.googleapis.com/youtube/v3/videos?id=" + YTPlayer.videoID + "&key=" + jQuery.mbYTPlayer.apiKey + "&part=snippet", function (data) {
          YTPlayer.dataReceived = true;
